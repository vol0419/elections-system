...
<div id="main" class="container">
        ...
        <table class="table table-striped">
            ...
            <c:forEach items="${candidateListPage.content}" var="candidate">
                <tr>
                    ...
                    <td>
                        <c:out value="${empty candidate.wynik?'Brak danych': candidate.wynik}" escapeXml="true"/>
                    </td>
                </tr>
    ...
    <security:authorize access="hasRole('ADMIN')">
        ...
        <a class="btn btn-success" href="candidateListOver.html?back=${1}">Anuluj ogłoszenie wyników</a>
    </security:authorize>
</div>
</body>
</html>
