...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeRequests()
                .antMatchers("/statics/**", "/webjars/**", "/", "/zaglosuj.html", "/votIsGood.html","/candidateList.html", "/registrationForm.html", "/error.html", "/kontakt.html", "/home.html", "/candidateDetails.html", "/votingActiveError.html", "/votError.html", "/info.html", "/doubleError.html", "/candidateListOver.html").permitAll()
                .antMatchers(  "/candidateForm.html").hasRole("ADMIN")
        ...
        http.formLogin().successForwardUrl("/home.html");
